...
static const struct fuse_opt option_spec[] = {
    OPTION("--device=%s", device), OPTION("-h", show_help),
 ...
 * @return int
 */
int jfs_rmdir(const char *path) { return jfs_unlink(path); }
/**
 * @brief
 *
 * @param from
...
int main(int argc, char **argv) {
  ...
  jfs_options.device = strdup("/home/students/220110828/HITSZ-OSLab-2024/driver/user_ddriver/bin/ddriver");
